...
;; 5th  type the following function in Jess command prompt for launching the jess inference engine and 
;; find out with rules did FIRE!... displaying data   
